...
/**
  * @brief Product name title=UM10441 Chapter title=LPC122x System control (SYSCON) Modification date=2/16/2011 Major revision=1 Minor revision=0  (FLASHPARAMCTRL)
  */

typedef struct {                            /*!< (@ 0x50060000) FLASHPARAMCTRL Structure    */
  __I  uint32_t RESERVED0[10];
  __IO uint32_t FLASHPARAMCFG;                   /*!< (@ 0x50060028) Flash read cycle configuration */
} LPC_FLASHPARAMCTRL_Type;
...
#define LPC_FLASHPARAMCTRL_BASE        (0x50060000)
...
#define LPC_FLASHPARAMCTRL             ((LPC_FLASHPARAMCTRL_Type      *) LPC_FLASHPARAMCTRL_BASE)
